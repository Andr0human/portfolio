...
export const Experience = (props) => {
  ...
  return (
    <ExperienceContainer id='experience'>
          ...
          {experiences?.map((exp, index) => (
            <TimelineItem key={`experience-${exp.company}-${index}`}>
              ...
              <TimelineContent>
                ...
                >
                  <Typography variant='h6' sx={{ fontWeight: 'bold', color: '#2d3748', marginBottom: '8px' }}>
                    {exp.role}
                  </Typography>
                  <Typography variant='subtitle1' sx={{ color: '#667eea', fontWeight: '600', marginBottom: '5px' }}>
                    {exp.company}
                  </Typography>
            ...
            <TimelineItem key={`education-${edu.school}-${index}`}>
              ...
              <TimelineContent>
                ...
                >
                  ...
                  <Typography variant='subtitle1' sx={{ color: '#ff6b6b', fontWeight: '600', marginBottom: '5px' }}>
                    {edu.school}
                  </Typography>
                  <Typography variant='subtitle2' sx={{ color: '#718096', marginBottom: '15px', fontStyle: 'italic' }}>
                    {edu.year}
      ...
      <motion.div
        animate={{ x: [0, 30, 0], y: [0, -20, 0], rotate: [0, 45, 90, 135, 180] }}
      ...
      />
      <motion.div
        animate={{ x: [0, -40, 0], y: [0, 25, 0], rotate: [0, -60, -120, -180, -240, -300, -360] }}
