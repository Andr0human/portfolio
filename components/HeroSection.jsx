  ...
  return (
    <HomeContainer id='home'>
      ...
      >
        ...
        <IconContainer>
          <motion.div variants={iconVariants} whileHover='hover' transition={{ duration: 0.2, ease: "easeOut" }}>
            <IconButton href='https://www.linkedin.com/in/ayushsinha3199' target='_blank' sx={{ color: 'white' }}>
              <LinkedInIcon size={30} />
            </IconButton>
          </motion.div>
          <motion.div variants={iconVariants} whileHover='hover' transition={{ duration: 0.2, ease: "easeOut" }}>
            <IconButton href='https://github.com/Andr0human' target='_blank' sx={{ color: 'white' }}>
              <GithubIcon size={30} />
            </IconButton>
          </motion.div>
          <motion.div variants={iconVariants} whileHover='hover' transition={{ duration: 0.2, ease: "easeOut" }}>
