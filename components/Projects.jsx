...
const StyledCarousel = styled(Carousel)({
  ...
  '& .react-multi-carousel-arrow': {
    ...
    '&::before': { color: '#667eea', fontSize: '16px', fontWeight: 'bold' },
  },
  '& .react-multi-carousel-arrow--left': { left: '20px' },
  '& .react-multi-carousel-arrow--right': { right: '20px' },
});
  ...
  return (
    <ProjectsContainer id='projects'>
      <Container maxWidth='lg'>
        ...
        >
          <SectionTitle variant='h3'>🚀 MY PROJECTS</SectionTitle>
        </motion.div>
      ...
      <motion.div
        animate={{ x: [0, 50, 0], y: [0, -30, 0], rotate: [0, 90, 180, 270, 360] }}
      ...
      />
      <motion.div
        animate={{ x: [0, -80, 0], y: [0, 60, 0], rotate: [0, -90, -180, -270, -360] }}
